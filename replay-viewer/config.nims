...
switch(
  "passL",
  (&"""
  -o {distDir / "cogchemists_replay.js"}
  -O2
  -s ALLOW_MEMORY_GROWTH
  -s ABORTING_MALLOC=1
  -s ENVIRONMENT=web
  -s MODULARIZE=1
  -s EXPORT_NAME=CogchemistsReplayModule
  -s EXPORTED_RUNTIME_METHODS=HEAPU8
  -s EXPORTED_FUNCTIONS=_main,_malloc,_free,_cc_load_replay,_cc_payload_ptr,_cc_payload_len,_cc_error_ptr,_cc_error_len
  """).replace("\n", " ")
)
